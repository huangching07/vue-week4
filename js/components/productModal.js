export default {
    ...
    methods: {
        createImages() {
            this.$emit('createImages-emit');
        },
        updateProduct() {
            this.$emit('updateProduct-emit');
        }
    },
    template: `
                        ...
                        <div class="col-sm-4">
                            ...
                            <div v-if="Array.isArray(tempProduct.imagesUrl)">
                                <div v-for="(image, key) in tempProduct.imagesUrl" :key="key">
                                    <input type="text" class="form-control" v-model="tempProduct.imagesUrl[key]"></input>
                                    <img :src="tempProduct.imagesUrl[key]" alt="" class="img-fluid my-2">
                                </div>
                                <div v-if="tempProduct.imagesUrl[tempProduct.imagesUrl.length - 1] != '' && tempProduct.imagesUrl.length < 5">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input id="origin_price" type="number" min="0" class="form-control" v-model="tempProduct.origin_price" placeholder="請輸入原價">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="price" class="form-label">售價</label>
                                    <input id="price" type="number" min="0" class="form-control" v-model="tempProduct.price" placeholder="請輸入售價">
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="description" type="text" class="form-control" v-model="tempProduct.content" placeholder="請輸入說明內容"></textarea>
                            </div>
                            <div class="mb-3">
